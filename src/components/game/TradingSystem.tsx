                ...
                <div className="space-y-2 max-h-32 overflow-y-auto">
                  {ownedProperties.map(property => (
                    ...
                    >
                      ...
                      <div className="text-xs text-purple-400">${property.currentValue.toLocaleString('en-US')}</div>
                    </div>
                  ))}
                </div>
              </div>
                      ...
                      {offer.offeredProperties.map(propId => {
                        ...
                        return prop ? (
                          <div key={propId} className="text-purple-200 text-xs">
                            🏠 {prop.name} (${prop.currentValue.toLocaleString('en-US')})
                          </div>
                        ) : null;
                      })}
                      {offer.offeredCash > 0 && (
                        <div className="text-green-300 text-xs">
                          💰 ${offer.offeredCash.toLocaleString('en-US')}
                        </div>
                      )}
                    </div>
                  </div>
                    ...
                    <div className="space-y-1">
                      ...
                      {offer.requestedCash > 0 && (
                        <div className="text-red-300 text-xs">
                          💰 ${offer.requestedCash.toLocaleString('en-US')}
                        </div>
                      )}
                    </div>
                  </div>
